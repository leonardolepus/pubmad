...
features = ['degree', 'triangles', 'degree_centrality', 'clustering', 'square_clustering', 'closeness_centrality', 'betweenness_centrality', 'eigenvector_centrality', 'katz_centrality_numpy', 'load_centrality', 'edge_betweenness_centrality', 'communicability_centrality']
