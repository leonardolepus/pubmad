...
plt.hist(at_as, bins = 100, range = (0, 1))
...
plt.scatter(as_at, at_as)
plt.savefig('graph_as_at_at_as.png')
...
plt.hist(ta_sa, bins = 100, range = (0, 1))
plt.savefig('digraph_ta_sa_hist.png')
plt.hist(sa_ta, bins = 100, range = (0, 1))
plt.savefig('digraph_sa_ta_hist.png')
plt.hist(bt_bs, bins = 100, range = (0, 1))
plt.savefig('digraph_bt_bs_hist.png')
plt.hist(bs_bt, bins = 100, range = (0, 1))
